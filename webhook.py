...
def descargar_media(media_url):
    try:
        # Timeout de 5s para evitar bloqueos si WAHA tarda
        url_final = media_url
...
def recibir_mensaje():
    ...
    # 4. Preparar Datos y Google Search (BLINDADO)
    ...
    try:
        ...
        print(f"⚠️ Error leve en Google Search (continuando): {e}")
    ...
    if has_media:
        try:
            ...
            if media_url: 
             ...
             print(f"⚠️ Error leve procesando media: {e}")
             body = "⚠️ Error Media"
    ...
    try:
        ...
        # Respondemos 200 a WAHA para evitar bucle de reintentos
