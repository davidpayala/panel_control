...
# Asegúrate de importar la función generar_feed_facebook desde utils si la moviste ahí
from utils import generar_feed_facebook 
                            ...
                            try:
                                with engine.connect() as conn:
                                    ...
                                    """), {
                                        ...
                                        "n_pre": new_precio, "n_prer": final_rebajado, 
                                        "old_sku": curr['sku']
                                    })
        ...
        if sku_to_split:
            ...
            if not res_split.empty:
                ...
                with st.form("form_split_product"):
                    ...
                    c4, c5 = st.columns(2)
                    idx_cat = 0
                    if curr['categoria'] in ["Lentes Contacto", "Pelucas", "Accesorios", "Liquidos"]:
                        idx_cat = ["Lentes Contacto", "Pelucas", "Accesorios", "Liquidos"].index(curr['categoria'])
                    n_cat = c4.selectbox("Categoría", ["Lentes Contacto", "Pelucas", "Accesorios", "Liquidos"], index=idx_cat)
