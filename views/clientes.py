...
# Importamos las funciones de Google y utilidades
from utils import buscar_contacto_google, crear_en_google, actualizar_en_google
            ...
            if st.button("🚀 FUSIONAR AHORA", type="primary"):
                with engine.connect() as conn:
                    ...
                    try:
                        ...
                        # 4. Actualizar el Principal (Guardamos el teléfono viejo como secundario si está vacío)
                        conn.execute(text("""
                            UPDATE Clientes 
